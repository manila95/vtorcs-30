...
static char* botname[NBBOTS] = {"gryffindor 1", "gryffindor 2", "gryffindor 3", "gryffindor 4", "gryffindor 5", "gryffindor 6", "gryffindor 7", "gryffindor 8", "gryffindor 9", "gryffindor 10"};
...
newrace(int index, tCarElt* car, tSituation *s)
{
    ...
    ***********************************************************************************/
    ...
    serverAddress[index].sin_port = htons(getUDPListenPort()+9+index);
    ...
    std::cout << "Waiting for request on port " << getUDPListenPort()+9+index << "\n";
