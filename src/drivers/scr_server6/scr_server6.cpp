...
static char* botname[NBBOTS] = {"ironmonger 1", "ironmonger 2", "ironmonger 3", "ironmonger 4", "ironmonger 5", "ironmonger 6", "ironmonger 7", "ironmonger 8", "ironmonger 9", "ironmonger 10"};
...
newrace(int index, tCarElt* car, tSituation *s)
{
    ...
    ***********************************************************************************/
    ...
    serverAddress[index].sin_port = htons(getUDPListenPort()+69+index);
    ...
    std::cout << "Waiting for request on port " << getUDPListenPort()+69+index << "\n";
